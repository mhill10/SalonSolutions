...
<head>
    ...
    <!-- jQuery slim -->
    <script src="http://code.jquery.com/jquery-3.1.1.slim.js" integrity="sha256-5i/mQ300M779N2OVDrl161bohwXNUdzL/R2aVUXyXWA=" crossorigin="anonymous"></script>
    ...
    <!-- Custom Stylesheet -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styleSheets/userDisplayStyleSheet.css">
